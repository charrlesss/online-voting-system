...
function logout(_, __, _a) {
    var req = _a.req, res = _a.res;
    return __awaiter(this, void 0, void 0, function () {
        var _id, updatedUser, upadate, _b, _c, _d, _e, err_1;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    return [4 /*yield*/, adminSchema_1.default.findOneAndUpdate({ _id: _id }, upadate, { new: true })];
                case 1:
                    _c = (_f.sent());
                    if (_c) return [3 /*break*/, 3];
                    return [4 /*yield*/, employeeSchema_1.default.findOneAndUpdate({ _id: _id }, upadate, { new: true })];
                case 2:
                    _c = (_f.sent());
                    _f.label = 3;
                case 3:
