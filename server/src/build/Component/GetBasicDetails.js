...
function fetchBasicDetails(_, __, _a) {
    var req = _a.req;
    return __awaiter(this, void 0, void 0, function () {
        var userDetails, _b, _c, err_1;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    userDetails = (_b);
                    return [2 /*return*/, userDetails.basicDetails.filter(function (data) { return Object.keys(data).length !== 0; })];
                case 6:
                    err_1 = _d.sent();
                    console.log('getDetails Eror: ' + err_1);
                    return [2 /*return*/, []];
...
exports.default = fetchBasicDetails;
