            ...
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, authenticateUser_1.default)(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, adminSchema_1.default.find({ "securedDetails.email": email })];
                                case 1:
                                    admin = _a.sent();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, adminSchema_1.default.findOneAndUpdate({ _id: user._id }, upadate, { new: true })];
                                case 1:
                                    _a.sent();
