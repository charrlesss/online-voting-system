        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, authenticateUser_1.default)(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        var ACCESS_TOKEN, REFRESH_TOKEN, secure, updateUser;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (err) {
                                    ...
                                    return [4 /*yield*/, votersSchema_1.default.findOneAndUpdate({ _id: user._id }, { "urlId": '' }, { new: true })];
                                case 1:
                                    _a.sent();
                                    secure = user.securedDetails[0];
                                    updateUser = __assign(__assign({}, secure), { refreshToken: [REFRESH_TOKEN], log: [{ login: new Date().toLocaleString() }] });
                                    return [4 /*yield*/, votersSchema_1.default.findOneAndUpdate({ _id: user._id }, { securedDetails: [updateUser] })];
                                case 2:
                                    _a.sent();
